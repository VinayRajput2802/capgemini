    ...
    public static void main(String[] args) {
        try {
            ...
            while (true) {
                ...
                System.out.println("CHANGE BOOK PRICE -- 6");
                ...
                if (choice == 1) {
                    ...
                    Update_Price_of_book up = new Update_Price_of_book();
                    System.out.print("ENTER AUTHOR ID OR ISBN: ");
                    Integer id = sc.nextInt();
                    sc.nextLine();
